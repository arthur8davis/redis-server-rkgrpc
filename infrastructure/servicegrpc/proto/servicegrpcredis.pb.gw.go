...
func RegisterRedisServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RedisServiceServer) error {
	...
	mux.Handle("GET", pattern_RedisService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/servicegrpc.RedisService/Get", runtime.WithHTTPPathPattern("/sp/srvgrpc/get"))
		if err != nil {
	...
	mux.Handle("POST", pattern_RedisService_Set_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/servicegrpc.RedisService/Set", runtime.WithHTTPPathPattern("/sp/srvgrpc/set"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterRedisServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RedisServiceClient) error {
	...
	mux.Handle("GET", pattern_RedisService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/servicegrpc.RedisService/Get", runtime.WithHTTPPathPattern("/sp/srvgrpc/get"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_RedisService_Set_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/servicegrpc.RedisService/Set", runtime.WithHTTPPathPattern("/sp/srvgrpc/set"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_RedisService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"sp", "srvgrpc", "get"}, ""))

	pattern_RedisService_Set_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"sp", "srvgrpc", "set"}, ""))
